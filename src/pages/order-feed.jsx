import styles from "../pages/order-feed.module.css"
      ...
      {/* onScroll={handleScroll} */}
        <div className={styles.orderContainer} key="order#1" style={ { border: isActive ? '2px dashed #4C4CFF' : 'none' } }> 
          <div className={styles.orderData}>
            ...
            <span className="text text_type_main-small text_color_inactive">Сегодня, 16:20 i-GMT+3</span>
          </div>
        ...
        <div className={styles.orderContainer} key="order#2">  
          <div className={styles.orderData}>
            <span className="text text_type_digits-default">#034535</span>
            <span className="text text_type_main-small text_color_inactive">Сегодня, 16:20 i-GMT+3</span>
          </div>
